    ...
    <main id="top">
      ...
      <section className="hero" aria-labelledby="hero-title">
        <div className="hero-copy">
          ...
          <div className="hero-note">
            <span>تصور قابل للتطوير</span>
            <p>المحتوى والأرقام تُحدّث فور استلام تفاصيل البرنامج.</p>
          </div>
        </div>
        ...
        <div className="section-intro">
          ...
          <div className="intro-copy">
            ...
            <p>
              ...
              الأداء ليصنع مساراً متكاملاً يمكن تطبيقه وتطويره ومشاركة أثره.
            </p>
          </div>
        </div>
      ...
      <section className="method-section" id="method">
        <div className="section-heading">
          ...
          <p>
            رحلة مترابطة تجعل الاستدامة جزءاً من عملية المشروع، لا تقريراً
            منفصلاً عنها.
          </p>
        </div>
      ...
      <section className="story-section" id="story">
        <div className="story-heading">
          ...
          <p>
            ...
            بدون الحاجة لإعادة بناء الموقع من الصفر.
          </p>
        </div>
        ...
        <div className="impact-preview">
          <div className="impact-copy">
            ...
            <h3>الأرقام عندما تصبح دليلاً على التغيير.</h3>
            <p>
          ...
          <div className="metric-list" aria-label="أمثلة على مؤشرات الأداء">
            {["كفاءة الطاقة", "ترشيد المياه", "المواد المسؤولة", "خفض الكربون"].map(
              (metric, index) => (
      ...
      <section className="next-section" id="next">
        <div className="next-quote">
          ...
          <blockquote>
            الموقع القادم لن يوثّق ما حدث فقط؛ بل سيجعل أثر البرنامج
            <em> مفهوماً، قابلاً للقياس، وملهماً للتكرار.</em>
          </blockquote>
        </div>

        <div className="needed-data" id="needed-data">
          <p>لتحويل هذا التصور إلى النسخة النهائية، نحتاج:</p>
          <ol>
            <li>
              <span>01</span>
              اسم البرنامج وهويته
      ...
      <footer>
        ...
        <p>تصور أولي لمنصة توثّق رحلة البرنامج وأثره.</p>
